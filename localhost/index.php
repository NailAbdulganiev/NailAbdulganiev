        ...
        <div class="main">
            <div class="block-1">
                ...
                <p class="hellopeople">
                    ...
                    <a href="https://www.youtube.com/channel/UC2yF84Y6GakHWN3_eC-6tRQ" target="_blank" class="yt">Youtube
                        канал</a>
            ...
            <div class="block-2">
                ...
                <p class="myEducation">
                    ...
                    хотел.
                    Я
                    реально усердно готовился к ЕГЭ, но мои баллы меня не удовлетворили (242 балла: информатика 77
                    баллов,
                    профильная математика: 74 балла, русский язык: 91 балл и ещё обществознание: 81 балл), но в Москву
                    на
                    бюджет
                    с такими баллами можно пройти. Конечно, в ВУЗы похуже, но всё же. Естественно, я рассматривал
                    Москву. В
                    первую волну, меня выкинули в последние полчаса, а во вторую волну случился баг в личном кабинете,
                    лишивший
                    меня бюджетного места в МГТУ Станкин. Было очень обидно, грустно, я впал в депрессию. А ещё из-за
                    Covid-19
                    все сроки были передвинуты, и я узнал, что никуда не поступил 27 августа. В результате, пришлось
                    подать
                    на
                    платку в региональный ВУЗ: Ульяновский политех. Вот такая вот история. <br><br>
                    ...
                    web-разработки
                    даст мне толчок в развитии навыков программиста. Буду улучшать свой сайт, чтобы им можно было
                    гордиться
                    и показывать пример верстки, которую я могу сделать.
                </p>
            </div>
        </div>
